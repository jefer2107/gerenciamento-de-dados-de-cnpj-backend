...
const routesController = (app)=>{
    ...
    app.get('/clients/getJoinClientsAndUsers',authorizeController().authorizeAdmin,clientsController().getJoinClientsAndUsers)
    app.get('/clients/:id/getOneJoinClientAndUsers',authorizeController().authorizeUser,clientsController().getOneJoinClientAndUsers)
    ...
    app.get('/users/getAllunauthenticated',usersController().getAllunauthenticated)
